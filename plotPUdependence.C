...
int plotPUdependenceEtaBinned(int etaBin){
  gDirectory->Delete(); 
  ...
  TGraphErrors *PU1, *PU2, *PU3, *PU4, *PU5;
  TH1 *vtx1, *vtx2, *vtx3, *vtx4, *vtx5;
  TH1 *vtx1Eta[pt_int], *vtx2Eta[pt_int], *vtx3Eta[pt_int], *vtx4Eta[pt_int], *vtx5Eta[pt_int];
  sourcePUle5.Form("plots_2012/PF_L1CHS/mc/Resolution_for_%i_eta_bin_intrinsic_PFCHS_mc_le5.root",etaBin+1);
  sourcePUle10gt5.Form("plots_2012/PF_L1CHS/mc/Resolution_for_%i_eta_bin_intrinsic_PFCHS_mc_le10gt5.root",etaBin+1);
  sourcePUle15gt10.Form("plots_2012/PF_L1CHS/mc/Resolution_for_%i_eta_bin_intrinsic_PFCHS_mc_le15gt10.root",etaBin+1);
  sourcePUle20gt15.Form("plots_2012/PF_L1CHS/mc/Resolution_for_%i_eta_bin_intrinsic_PFCHS_mc_le20gt15.root",etaBin+1);
  sourcePUgt20.Form("plots_2012/PF_L1CHS/mc/Resolution_for_%i_eta_bin_intrinsic_PFCHS_mc_gt20.root",etaBin+1);

  PU1 = readTGraphErrors(sourcePUle5,"Graph","Graph");
  PU2 = readTGraphErrors(sourcePUle10gt5,"Graph","Graph");
  PU3 = readTGraphErrors(sourcePUle15gt10,"Graph","Graph");
  PU4 = readTGraphErrors(sourcePUle20gt15,"Graph","Graph");
  PU5 = readTGraphErrors(sourcePUgt20,"Graph","Graph");
  ...
  legend1  = new TLegend(0.4,0.7,0.9,0.9);
  legend1 -> SetFillColor(0);
  legend1 -> SetTextSize(0.030);
  
  PU1->GetFunction("fResolution")->SetLineColor(3);
  PU1->SetMarkerColor(3);
  PU1->SetLineColor(3);
  PU1->SetMinimum(0.0);
  PU1->SetMaximum(0.70);
  PU1->Draw("AP");
  legend1 -> AddEntry(PU1,"NPU #leq 5","l");

  PU2->GetFunction("fResolution")->SetLineColor(4);
  PU2->SetMarkerColor(4);
  PU2->SetLineColor(4);
  PU2->Draw("Psame");
  legend1 -> AddEntry(PU2,"5 < NPU #leq 10","l");

  PU3->GetFunction("fResolution")->SetLineColor(5);
  PU3->SetMarkerColor(5);
  PU3->SetLineColor(5);
  PU3->Draw("Psame");
  legend1 -> AddEntry(PU3,"10 < NPU #leq 15","l");

  PU4->GetFunction("fResolution")->SetLineColor(6);
  PU4->SetMarkerColor(6);
  PU4->SetLineColor(6);
  PU4->Draw("Psame");
  legend1 -> AddEntry(PU4,"15 < NPU #leq 20","l");

  PU5->GetFunction("fResolution")->SetLineColor(7);
  PU5->SetMarkerColor(7);
  PU5->SetLineColor(7);
  PU5->Draw("Psame");
  legend1 -> AddEntry(PU5,"20 < NPU","l");

  //legend -> Draw("same");
  //
  //delete legend;  

  double xN[5], xS[5], xm[5],xC[5], xEta[5], xEtaError[5];
  ...
  xN[0] = PU1->GetFunction("fResolution")->GetParameter("N"); 
  xN[1] = PU2->GetFunction("fResolution")->GetParameter("N"); 
  xN[2] = PU3->GetFunction("fResolution")->GetParameter("N"); 
  xN[3] = PU4->GetFunction("fResolution")->GetParameter("N"); 
  xN[4] = PU5->GetFunction("fResolution")->GetParameter("N"); 
  
  xS[0] = PU1->GetFunction("fResolution")->GetParameter("S"); 
  xS[1] = PU2->GetFunction("fResolution")->GetParameter("S"); 
  xS[2] = PU3->GetFunction("fResolution")->GetParameter("S"); 
  xS[3] = PU4->GetFunction("fResolution")->GetParameter("S"); 
  xS[4] = PU5->GetFunction("fResolution")->GetParameter("S");
  
  xm[0] = PU1->GetFunction("fResolution")->GetParameter("m"); 
  xm[1] = PU2->GetFunction("fResolution")->GetParameter("m"); 
  xm[2] = PU3->GetFunction("fResolution")->GetParameter("m"); 
  xm[3] = PU4->GetFunction("fResolution")->GetParameter("m"); 
  xm[4] = PU5->GetFunction("fResolution")->GetParameter("m");

  xC[0] = PU1->GetFunction("fResolution")->GetParameter("C"); 
  xC[1] = PU2->GetFunction("fResolution")->GetParameter("C"); 
  xC[2] = PU3->GetFunction("fResolution")->GetParameter("C"); 
  xC[3] = PU4->GetFunction("fResolution")->GetParameter("C"); 
  xC[4] = PU5->GetFunction("fResolution")->GetParameter("C"); 
  
   
  
  xNError[0] = PU1->GetFunction("fResolution")->GetParError(PU1->GetFunction("fResolution")->GetParNumber("N")); 
  xNError[1] = PU2->GetFunction("fResolution")->GetParError(PU2->GetFunction("fResolution")->GetParNumber("N")); 
  xNError[2] = PU3->GetFunction("fResolution")->GetParError(PU3->GetFunction("fResolution")->GetParNumber("N")); 
  xNError[3] = PU4->GetFunction("fResolution")->GetParError(PU4->GetFunction("fResolution")->GetParNumber("N")); 
  xNError[4] = PU5->GetFunction("fResolution")->GetParError(PU5->GetFunction("fResolution")->GetParNumber("N")); 
  
  xSError[0] = PU1->GetFunction("fResolution")->GetParError(PU1->GetFunction("fResolution")->GetParNumber("S")); 
  xSError[1] = PU2->GetFunction("fResolution")->GetParError(PU2->GetFunction("fResolution")->GetParNumber("S")); 
  xSError[2] = PU3->GetFunction("fResolution")->GetParError(PU3->GetFunction("fResolution")->GetParNumber("S")); 
  xSError[3] = PU4->GetFunction("fResolution")->GetParError(PU4->GetFunction("fResolution")->GetParNumber("S")); 
  xSError[4] = PU5->GetFunction("fResolution")->GetParError(PU5->GetFunction("fResolution")->GetParNumber("S"));
  
  xmError[0] = PU1->GetFunction("fResolution")->GetParError(PU1->GetFunction("fResolution")->GetParNumber("m")); 
  xmError[1] = PU2->GetFunction("fResolution")->GetParError(PU2->GetFunction("fResolution")->GetParNumber("m")); 
  xmError[2] = PU3->GetFunction("fResolution")->GetParError(PU3->GetFunction("fResolution")->GetParNumber("m")); 
  xmError[3] = PU4->GetFunction("fResolution")->GetParError(PU4->GetFunction("fResolution")->GetParNumber("m")); 
  xmError[4] = PU5->GetFunction("fResolution")->GetParError(PU5->GetFunction("fResolution")->GetParNumber("m")); 
  
  xCError[0] = PU1->GetFunction("fResolution")->GetParError(PU1->GetFunction("fResolution")->GetParNumber("C")); 
  xCError[1] = PU2->GetFunction("fResolution")->GetParError(PU2->GetFunction("fResolution")->GetParNumber("C")); 
  xCError[2] = PU3->GetFunction("fResolution")->GetParError(PU3->GetFunction("fResolution")->GetParNumber("C")); 
  xCError[3] = PU4->GetFunction("fResolution")->GetParError(PU4->GetFunction("fResolution")->GetParNumber("C")); 
  xCError[4] = PU5->GetFunction("fResolution")->GetParError(PU5->GetFunction("fResolution")->GetParNumber("C")); 
 
  for(int ptBin=0; ptBin<10; ptBin++){
    sourcePUle5.Form("plots_2012/PF_L1CHS/mc/root_files/hVtxN1_%i_Pt_bin_%i_eta_bin_PFCHS_mc.root",ptBin+1,etaBin+1);
    sourcePUle10gt5.Form("plots_2012/PF_L1CHS/mc/root_files/hVtxN2_%i_Pt_bin_%i_eta_bin_PFCHS_mc.root",ptBin+1,etaBin+1);
    sourcePUle15gt10.Form("plots_2012/PF_L1CHS/mc/root_files/hVtxN3_%i_Pt_bin_%i_eta_bin_PFCHS_mc.root",ptBin+1,etaBin+1);
    sourcePUle20gt15.Form("plots_2012/PF_L1CHS/mc/root_files/hVtxN4_%i_Pt_bin_%i_eta_bin_PFCHS_mc.root",ptBin+1,etaBin+1);
    sourcePUgt20.Form("plots_2012/PF_L1CHS/mc/root_files/hVtxN5_%i_Pt_bin_%i_eta_bin_PFCHS_mc.root",ptBin+1,etaBin+1);
    

    TFile * file = TFile::Open(sourcePUle5);
    file->GetObject("histo",vtx1Eta[ptBin]);
    vtx1Eta[ptBin] -> SetDirectory(0);
    delete file;
    file = TFile::Open(sourcePUle10gt5);
    file->GetObject("histo",vtx2Eta[ptBin]);
    vtx2Eta[ptBin] -> SetDirectory(0);
    delete file;
    file = TFile::Open(sourcePUle15gt10);
    file->GetObject("histo",vtx3Eta[ptBin]);
    vtx3Eta[ptBin] -> SetDirectory(0);
    delete file;
    file = TFile::Open(sourcePUle20gt15);
    file->GetObject("histo",vtx4Eta[ptBin]);
    vtx4Eta[ptBin] -> SetDirectory(0);
    delete file;
    file = TFile::Open(sourcePUgt20);
    file->GetObject("histo",vtx5Eta[ptBin]);
    vtx5Eta[ptBin] -> SetDirectory(0);
    delete file;
  }

  cout<<vtx1Eta[0]->GetMean(1)<<endl;
  for(int ptBin=1; ptBin<10; ptBin++){

    vtx1Eta[0]->Add(vtx1Eta[ptBin]);
    vtx2Eta[0]->Add(vtx2Eta[ptBin]);
    vtx3Eta[0]->Add(vtx3Eta[ptBin]);
    vtx4Eta[0]->Add(vtx4Eta[ptBin]);
    vtx5Eta[0]->Add(vtx5Eta[ptBin]);

  }

  xEta[0] = vtx1Eta[0] -> GetMean(1);
  xEta[1] = vtx2Eta[0] -> GetMean(1);
  xEta[2] = vtx3Eta[0] -> GetMean(1);
  xEta[3] = vtx4Eta[0] -> GetMean(1);
  xEta[4] = vtx5Eta[0] -> GetMean(1);

  xEtaError[0] = vtx1Eta[0] -> GetMeanError(1);
  xEtaError[1] = vtx2Eta[0] -> GetMeanError(1);
  xEtaError[2] = vtx3Eta[0] -> GetMeanError(1);
  xEtaError[3] = vtx4Eta[0] -> GetMeanError(1);
  xEtaError[4] = vtx5Eta[0] -> GetMeanError(1);

  cout<<xEta[0]<<endl;
  cout<<xEtaError[0]<<endl;

  TGraphErrors *N = new TGraphErrors(5,xEta,xN,xEtaError,xNError);
  TGraphErrors *S = new TGraphErrors(5,xEta,xS,xEtaError,xSError);
  TGraphErrors *m = new TGraphErrors(5,xEta,xm,xEtaError,xmError);
  TGraphErrors *C = new TGraphErrors(5,xEta,xC,xEtaError,xCError);
  ...
  info->DrawLatex(0.50,0.55,  etaRegion.Data());
  info->DrawLatex(0.50,0.45, "Anti-k_{T} 0.5 PFCHSJets");
  
  pdfFile.Form("PUdependence/PUDependecy_%i_EtaBin_FitParameter.pdf",etaBin+1);
  c2->SaveAs(pdfFile);
  delete info;


  double xPt[pt_int], yJER[pt_int], xPtError[pt_int], yJERError[pt_int];
  ...
  TFile * file = TFile::Open(sourcePUle5);
  file->GetObject("histo",vtx1);
  vtx1 -> SetDirectory(0);
  delete file;
  file = TFile::Open(sourcePUle10gt5);
  file->GetObject("histo",vtx2);
  vtx2 -> SetDirectory(0);
  delete file;
  file = TFile::Open(sourcePUle15gt10);
  file->GetObject("histo",vtx3);
  vtx3 -> SetDirectory(0);
  delete file;
  file = TFile::Open(sourcePUle20gt15);
  file->GetObject("histo",vtx4);
  vtx4 -> SetDirectory(0);
  delete file;
  file = TFile::Open(sourcePUgt20);
  file->GetObject("histo",vtx5);
  vtx5 -> SetDirectory(0);
  delete file;

  TGraphErrors *PUdep1;

  TF1* f1 = new TF1("name","pol1",0,25);   

  double x[5], xError[5], y[5], yError[5];


  PU1->GetPoint(ptBin,x[0],y[0]);
  PU2->GetPoint(ptBin,x[1],y[1]);
  PU3->GetPoint(ptBin,x[2],y[2]);
  PU4->GetPoint(ptBin,x[3],y[3]);
  PU5->GetPoint(ptBin,x[4],y[4]);
  cout<<"x = "<<x[0]<<endl;
  yError[0] = PU1 -> GetErrorY(ptBin);
  yError[1] = PU2 -> GetErrorY(ptBin);
  yError[2] = PU3 -> GetErrorY(ptBin);
  yError[3] = PU4 -> GetErrorY(ptBin);
  yError[4] = PU5 -> GetErrorY(ptBin);
  ...
  xError[0] = vtx1->GetMeanError(1);
  xError[1] = vtx2->GetMeanError(1);
  xError[2] = vtx3->GetMeanError(1);
  xError[3] = vtx4->GetMeanError(1);
  xError[4] = vtx5->GetMeanError(1);

  TGraphErrors * all = new TGraphErrors(5,x,y,xError,yError);

  TFitResultPtr r = all->Fit("name","SQ");
  double cl = 0.683;  // for 1 sigma error
  double Xaux[5], XauxError[5],XauxSum, XauxSumError, aux, weight[5];
	
  XauxSum = 0;
  XauxSumError = 0;
  PU1->GetPoint(ptBin,Xaux[0],aux);
  XauxError[0] = PU1->GetErrorX(ptBin);
  
  PU2->GetPoint(ptBin,Xaux[1],aux);
  XauxError[1] = PU2->GetErrorX(ptBin);
  
  PU3->GetPoint(ptBin,Xaux[2],aux);
  XauxError[2] = PU3->GetErrorX(ptBin);
  
  PU4->GetPoint(ptBin,Xaux[3],aux);
  XauxError[3] = PU4->GetErrorX(ptBin);
  
  PU5->GetPoint(ptBin,Xaux[4],aux);
  XauxError[4] = PU5->GetErrorX(ptBin);
  

  for(int i =0; i<5;i++){

    weight[i] = 1./TMath::Power(XauxError[i],2);
    XauxSum += Xaux[i]*weight[i];
    XauxSumError += weight[i];
  }
  XauxSum = XauxSum/XauxSumError;
  XauxSumError = TMath::Sqrt(1./XauxSumError);

  cout<<"XauxSum = "<<XauxSum<<endl;
  cout<<"XauxSumError = "<<XauxSumError<<endl;
  xPt[ptBin] = XauxSum;
  cout<<"xPt = "<<xPt[ptBin]<<endl;
  xPtError[ptBin] = XauxSumError;
  yJER[ptBin] = f1->Eval(140.0);
  cout<<yJER[ptBin]<<endl;
  //yJERError[ptBin] = 0;
  //yJERError[ptBin] = ((f1->GetParameter(0)+f1->GetParError(0) + (f1->GetParameter(1)+f1->GetParError(1))*140.) - (f1->GetParameter(0)-f1->GetParError(0) + (f1->GetParameter(1)-f1->GetParError(1))*140.))/2.;

  yJERError[ptBin] =TMath::Sqrt(TMath::Power(140.,2)*TMath::Power(f1->GetParError(1),2)+TMath::Power(f1->GetParError(0),2)); 
  //r->GetConfidenceIntervals(1,1,1,140.0,yJERError[ptBin],cl,true);

  TCanvas *c1 = new TCanvas("c1",title,200,10,450,450);
  ...
  all->SetTitle("NPU Dependency of JER");
  all->GetXaxis()->SetTitle("NPU");
  all->GetYaxis()->SetTitle("JER");
  all->SetMinimum(0.00);
  all->SetMaximum(0.30);
  all -> GetYaxis() -> SetTitleOffset(1.5); 
  all->Draw("AP");
  if (ptBin==pt_int-1) ptRegion.Form(" %4.1f GeV < p_{T}^{#gamma} \n",ptBorders[ptBin]);
  else                 ptRegion.Form("%4.1f GeV < p_{T}^{#gamma} < %4.1f GeV \n" ,ptBorders[ptBin], ptBorders[ptBin+1]);
  ...
  info->DrawLatex(0.15,0.2,  EtaPtRegion);
  info->DrawLatex(0.50,0.2, "Anti-k_{T} 0.5 PFCHSJets");
  
  EtaPtRegion.Form("%5.4f * x + %5.4f",f1->GetParameter(0),f1->GetParameter(1));
  info->DrawLatex(0.15,0.75, EtaPtRegion);
  
  EtaPtRegion.Form("Chi2 = %5.2f, ndof = %i",f1->GetChisquare(),f1->GetNDF());
  info->DrawLatex(0.15,0.85, EtaPtRegion);
  
  
  pdfFile.Form("PUdependence/PUDependecy_%i_EtaBin_%i_PtBin.pdf",etaBin+1,ptBin+1);
  c1->SaveAs(pdfFile);
  }

  TGraphErrors* final = new TGraphErrors(pt_int,xPt,yJER,xPtError,yJERError);

  TF1* fResolution = new TF1("fResolution","TMath::Sqrt(TMath::Sign(1,[0])*TMath::Power([0]/x,2)+TMath::Power([1],2)*TMath::Power(x,[3]-1)+TMath::Power([2],2))", ptBorders[0], 600);
  fResolution->SetParName(0,"N");
  fResolution->SetParName(1,"S");
  fResolution->SetParName(2,"C");
  fResolution->SetParName(3,"m");
  
  fResolution->SetParameter(0,1.13); 
  fResolution->SetParameter(1,0.611); 
  fResolution->FixParameter(2,0.0); 
  fResolution->SetParameter(3,0.143); 
  
  final->Fit("fResolution","QR");
  c->cd();

  final->GetFunction("fResolution")->SetLineColor(9);
  final->SetMarkerColor(9);
  final->SetLineColor(9);
  final->Draw("Psame");
  legend1 -> AddEntry(final,"NPU = 140 (extrapolation)","l");
  legend1->Draw("same");
  delete info;
  info   = new TLatex();
  info->SetTextFont(132);
  ...
  info->DrawLatex(0.45,0.45, "Anti-k_{T} 0.5 PFCHSJets");
  
  //EtaPtRegion.Form("%5.4f * x + %5.4f",f1->GetParameter(0),f1->GetParameter(1));
  //info->DrawLatex(0.15,0.75, EtaPtRegion);
  
  EtaPtRegion.Form("Chi2 = %5.2f, ndof = %i",fResolution->GetChisquare(),fResolution->GetNDF());
  info->DrawLatex(0.45,0.50, EtaPtRegion);
  
  EtaPtRegion.Form("#splitline{N = %4.1f (#pm %4.1f), S = %5.5f (#pm %5.5f)}{m = %4.1f (#pm %4.1f)}",fResolution->GetParameter("N"),fResolution->GetParError(fResolution->GetParNumber("N")),fResolution->GetParameter("S"),fResolution->GetParError(fResolution->GetParNumber("S")),fResolution->GetParameter("m"),fResolution->GetParError(fResolution->GetParNumber("m")));
  info->DrawLatex(0.23,0.60, EtaPtRegion);
  
  pdfFile.Form("PUdependence/PUDependecy_%i_EtaBin.pdf",etaBin+1);
  c -> SaveAs(pdfFile);
  delete info;

  // Plots for fitting Fit Paramters
...
int plotPUdependence(){
  ...
  //for(int etaBin=0; etaBin<1; etaBin++){
    ...
    xN[0]      = PU[0]->GetFunction("fResolution")->GetParameter("N");
    xNError[0] = PU[0]->GetFunction("fResolution")->GetParError(PU[0]->GetFunction("fResolution")->GetParNumber("N"));  
    xS[0]      = PU[0]->GetFunction("fResolution")->GetParameter("S"); 
    xSError[0] = PU[0]->GetFunction("fResolution")->GetParError(PU[0]->GetFunction("fResolution")->GetParNumber("S"));  
    xm[0]      = PU[0]->GetFunction("fResolution")->GetParameter("m"); 
    xmError[0] = PU[0]->GetFunction("fResolution")->GetParError(PU[0]->GetFunction("fResolution")->GetParNumber("m"));  
    xC[0]      = PU[0]->GetFunction("fResolution")->GetParameter("C");
    xCError[0] = PU[0]->GetFunction("fResolution")->GetParError(PU[0]->GetFunction("fResolution")->GetParNumber("C"));  
    ...
    //fResolution->FixParameter(0,xN[0]);
    fResolution->FixParameter(1,xS[0]);
    fResolution->FixParameter(3,xm[0]);
    fResolution->FixParameter(2,0);


   

    for(int puBin = 1; puBin<NPUbins; puBin++){
      ...
      //cout<<endl<<"Chi2_1/NDF = "<<chi2NDF[1]<<endl<<endl;
    ...
    for(int run =0 ; run<l; run++){
      cout<<"x["<<run<<"] = "<<x[run]<<endl;
      cout<<"xErr["<<run<<"] = "<<xErr[run]<<endl;
      cout<<"y["<<run<<"] = "<<y[run]<<endl;
      cout<<"yErr["<<run<<"] = "<<yErr[run]<<endl<<endl;
    }
    */
    ...
    // TF1 *fit = new TF1("fit","sqrt(pow([2] + [3] * int(x/1000.) ,2)/(x-int(x/1000.)*1000.) + [0]*[0]*pow(x,[1]-1))",0.,40*1000,4);
    ...
    //TGraphErrors *N = new TraphErrors(NPUbins,xEta,xN,xEtaError,xNError);
    ...
    TF1* f1;
    TF1* horizontalS = new TF1("horizontalS","pol0",0,30);
    TF1* horizontalm = new TF1("horizontalm","pol0",0,30);
  
    //S->Fit("horizontalS","SQ"); 
    //m->Fit("horizontalm","SQ");

    //fResolution->FixParameter(1,horizontalS->GetParameter(0));
    //fResolution->FixParameter(3,horizontalm->GetParameter(0));
    //fResolution->FixParameter(2,0);
    ...
    */
    ...
    if(linear == 1) pdfFile.Form("PUdependence/PUDependecy_%i_EtaBin_FitParameter_linear.pdf",etaBin+1);
    else pdfFile.Form("PUdependence/PUDependecy_%i_EtaBin_FitParameter_sqrt.pdf",etaBin+1);
    c2->SaveAs(pdfFile);
    delete c2;
    delete info;
    //====================================================================================================================================================================================
    ...
    info->DrawLatex(0.25,0.55, text);
      ...
      if(linear == 1)      pdfFile.Form("PUdependence/PUDependecy_%i_EtaBin_linear.pdf",etaBin+1);
      else if(linear == 0) pdfFile.Form("PUdependence/PUDependecy_%i_EtaBin_sqrt.pdf",etaBin+1);
      c -> SaveAs(pdfFile);
      delete info;
      delete legend1;
      delete c;
  ...
  legend1->Draw("same");
  if(linear == 1) pdfFile.Form("PUdependence/Chisquare_linear.pdf");
  else pdfFile.Form("PUdependence/Chisquare_sqrt.pdf");
  c6->SaveAs(pdfFile);
  legend1->Draw("same");
  delete legend1;
  ...
  if(linear == 1) pdfFile.Form("PUdependence/DeltaJER_linear.pdf");
  else            pdfFile.Form("PUdependence/DeltaJER_sqrt.pdf");
  c5 -> SaveAs(pdfFile);
