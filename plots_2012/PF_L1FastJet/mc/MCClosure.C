...
int MCClosure(){
  ...
  for(int j=0; j<4; j++){
    ...
    fileName.Form("root_files%s/Resolution_for_%i_eta_bin_PF_mc.root",file1,j+1);
    ...
    fileName.Form("root_files%s/Resolution_for_%i_eta_bin_intrinsic_PF_mc.root",file1,j+1);
