...
void calcPUMCdist(){
  ...
  TH1D *hPUMCDist = new TH1D("hPUMCDist","PU Distribution in MC",60,0,60);
  hPUMCDist -> Sumw2();
  hPUMCDist -> SetXTitle("# PU");
  
  // Add Chain to MC Sample
  TString DataFilename = "/scratch/hh/current/cms/user/mschrode/mc/GJets_Fall11/G_Pt-15to3000_TuneZ2_Flat_pythia6/";
  DataFilename += "G_Pt-15to3000_pythia6-Z2_Fall11_AK5PF_L1FastJet_*.root";  
  ...
  hPUDataDist[0] =  readTH1("MyDataPileupHistogramHLT_Photon20_CaloIdVL_IsoL.root","pileup;1","pileup0", 0);
  hPUDataDist[1] =  readTH1("MyDataPileupHistogramHLT_Photon30_CaloIdVL_IsoL.root","pileup;1","pileup1", 0);
  hPUDataDist[2] =  readTH1("MyDataPileupHistogramHLT_Photon50_CaloIdVL_IsoL.root","pileup;1","pileup2", 0);
  hPUDataDist[3] =  readTH1("MyDataPileupHistogramHLT_Photon75_CaloIdVL_IsoL.root","pileup;1","pileup3", 0);
  hPUDataDist[4] =  readTH1("MyDataPileupHistogramHLT_Photon90_CaloIdVL_IsoL.root","pileup;1","pileup4", 0);
